...
//		}
	...
	*/
	private void actionsToReorganize() {
        ...
        NarrativeWriter.write(String.format("!!! [REORG] Agent %d is initiating Reorganization. Disconnecting from Parent and Children to find new position.\n", myId));
        NarrativeWriter.write("    Reason: " + this.config.reorganizationStrategy + "\n");
