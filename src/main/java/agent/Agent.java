...
//        }
    ...
    public double[] getHardCostsArr() {
        return this.hard_costs_arr;
    }
    public void setHardCostsArr(double[] hard_costs_arr) {
        this.hard_costs_arr = hard_costs_arr;
    }
}
